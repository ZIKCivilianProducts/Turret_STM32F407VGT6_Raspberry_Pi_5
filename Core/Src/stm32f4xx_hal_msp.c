...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC4     ------> ADC1_IN14
    */
    HAL_GPIO_DeInit(ADC_AZ_GPIO_Port, ADC_AZ_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(ADC_EL_GPIO_Port, ADC_EL_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, Encoder_EL_A_Pin|Encoder_EL_B_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, Encoder_AZ_A_Pin|Encoder_AZ_B_Pin);
